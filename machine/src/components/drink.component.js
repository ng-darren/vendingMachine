...
class Drink extends Component {
  render() {
    const { drink, selected, cardClicked, key } = this.props
    ...
    return (<div className={drink.stock > 0? (selected? 'card selected' : 'card') : 'card disabled'}
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  {drink.price && <CurrencyFormat value={drink.price / 100} displayType={'text'} decimalScale={2} fixedDecimalScale={true} prefix={'$'} />}
                </p>
